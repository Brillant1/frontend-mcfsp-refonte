        ...
        <div class="modal-dialog"  @click.stop>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="font-bold text-center text-delete">Voulez-vous vraiment supprimer cette filière ?</h2>
                </div>
...
export default {
    ...
    computed: {
        openDeleteModal(){
            return useFiliereStore().getOpenDeleteModal
        }
    },
    methods: {    
        closeDeleteModal(){
