        ...
        <div class="modal-dialog"  @click.stop>
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2 class="font-bold text-center text-delete">Voulez-vous vraiment supprimer cette annonce ?</h2>
                </div>
...
export default {
    ...
    computed: {
        openDeleteModal(){
            return useAnnonceStore().getOpenDeleteModal
        }
    },
    methods: {    
        closeDeleteModal(){
